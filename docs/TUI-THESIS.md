...
无居中。装饰堆叠即噪声。唯一例外：transcript user 消息左上方短横衬线 `───`(tui-1-s1-r1) + 正文续行悬挂缩进
...
- I6-4 修订（2026-08-11，S1 首行界栏；2026-08-13 tui-1-s1-r1 改短横衬线）：衬线 `───`(tui-1-s1-r1)独立成行，正文全部续行两空格悬挂缩进，

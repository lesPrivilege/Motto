...
export async function exportSessionToHtml(
	...
	if (!outputPath) {
		...
		outputPath = `pi-session-${sessionBasename}.html`; // brand policy: platform artifact prefix stays pi
	}
...
export async function exportFromFile(inputPath: string, options?: ExportOptions | string): Promise<string> {
	...
	if (!outputPath) {
		...
		outputPath = `pi-session-${inputBasename}.html`; // brand policy: platform artifact prefix stays pi
	}
